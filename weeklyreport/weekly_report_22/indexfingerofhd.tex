...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.8\linewidth}
		\includegraphics[width=\linewidth]{Figures/fknet/hd-roc_compare_new.eps}
	\end{subfigure}
	\begin{subfigure}[b]{0.8\linewidth}
...
\textcolor{red}{Update CMC Curve and ROC Curve with EfficientNet, DeConvRFNet and RFNet.}
