...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.8\linewidth}
		\includegraphics[width=\linewidth]{Figures/fknet/cross-hd-roc_compare_new.eps}
	\end{subfigure}
    \begin{subfigure}[b]{0.8\linewidth}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{0.8\linewidth}
		\includegraphics[width=\linewidth]{Figures/fknet/cross-thu-roc_compare_new.eps}
	\end{subfigure}
    \begin{subfigure}[b]{0.8\linewidth}
